...
public class ConsultarPublicaciones extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_consultar_publicaciones);
    ...
    public void consultarVentas(View v){
        ...
        controlhelper.abrir();
        int count = controlhelper.consultarPubli(fecha,codigo);
